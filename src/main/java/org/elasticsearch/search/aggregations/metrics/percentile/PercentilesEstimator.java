...
public abstract class PercentilesEstimator {
    ...
    public abstract Flyweight flyweight(long bucketOrd);

    public abstract Flyweight emptyFlyweight();
     ...
     */
    public abstract static class Flyweight<E extends PercentilesEstimator, F extends Flyweight<E, F>> implements Streamable {

        protected double[] percents;

        protected Flyweight() {} // for serialization

        protected Flyweight(double[] percents) {
            this.percents = percents;
        }
        ...
        public static interface Merger<E extends PercentilesEstimator, F extends Flyweight<E, F>> {

            public abstract void add(F flyweight);

            public abstract Flyweight<E, F> merge();
        }
    }
    ...
    static class Streams {
        ...
        static Flyweight read(StreamInput in) throws IOException {
            switch (in.readByte()) {
                case Frugal.ID: return Frugal.Flyweight.readNewFrom(in);
                case QDigest.ID : return QDigest.Flyweight.read(in);
        ...
        static void write(Flyweight estimator, StreamOutput out) throws IOException {
