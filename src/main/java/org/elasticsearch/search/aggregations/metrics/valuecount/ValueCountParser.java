...
public class ValueCountParser implements Aggregator.Parser {
    ...
    public AggregatorFactory parse(String aggregationName, XContentParser parser, SearchContext context) throws IOException {
        ...
        ValuesSourceConfig<BytesValuesSource> config = XContentPushParser.object(
                new ValueSourceParser<BytesValuesSource>(BytesValuesSource.class, context)).parse(parser);
