...
public class TDigest extends PercentilesEstimator {
    ...
    public static class Flyweight extends PercentilesEstimator.Flyweight<TDigest, Flyweight> {
        ...
        private class Merger implements PercentilesEstimator.Flyweight.Merger<TDigest, Flyweight> {
